    ...
    <div className="min-h-screen bg-white">
      ...
      <main id="main-content">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-white">
                ...
                <div className="flex flex-wrap gap-4">
                  <a
                    href="#visit"
                    className="group inline-flex items-center gap-2 px-8 py-4 text-base font-bold text-gray-900 bg-white hover:bg-gray-50 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#00213a]"
                  >
                    Schedule a Tour
                    <ArrowRightIcon />
                  </a>
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                {[
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-3 bg-gray-100 hover:bg-[#00213a] text-gray-900 hover:text-white rounded-full font-semibold text-sm transition-all duration-200 border border-gray-300 hover:border-[#00213a] hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-[#00213a] focus-visible:ring-offset-2"
                  >
                    {link.icon}
                    {link.label}
                  </a>
        ...
        <section id="about" className="py-24 bg-gradient-to-b from-gray-50 to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-3 gap-6">
              {/* Large Feature Box */}
              <div className="lg:col-span-2 lg:row-span-2 bg-gradient-to-br from-[#00213a] via-[#003a5d] to-[#00213a] rounded-3xl p-10 text-white relative overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
              ...
              {/* Mission Box */}
              <div className="group bg-white rounded-3xl p-8 border-2 border-gray-200 hover:border-[#00213a] hover:shadow-xl transition-all duration-300">
                <div className="w-14 h-14 bg-[#00213a]/10 rounded-2xl flex items-center justify-center mb-4 text-[#00213a] group-hover:scale-110 transition-transform duration-300">
                  <BookIcon />
                </div>
              ...
              {/* Values Box */}
              <div className="bg-gradient-to-br from-[#fdbb2e] via-[#fdc951] to-[#fdd874] rounded-3xl p-8 text-gray-900 shadow-xl hover:shadow-2xl transition-shadow duration-300">
        ...
        <section id="programs" className="py-24 bg-white relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-[#00213a]/10 text-[#00213a] px-4 py-2 rounded-full mb-4 font-bold text-sm">
                <SparklesIcon />
                Our Programs
              </div>
              <h2 className="text-5xl font-black text-gray-900 mb-4">
                Signature <span className="text-[#00213a]">Programs</span>
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Dual Language */}
              <div className="group relative bg-white rounded-3xl overflow-hidden border-2 border-gray-200 hover:border-[#00213a] transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-[#00213a]/10 to-transparent rounded-bl-[120px] group-hover:from-[#00213a]/20 transition-colors duration-300"></div>
                <div className="relative p-8 sm:p-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#00213a] via-[#003a5d] to-[#00213a] rounded-2xl flex items-center justify-center mb-6 shadow-lg text-white group-hover:scale-110 transition-transform duration-300">
                    <GlobeIcon />
                  </div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-[#00213a] font-bold group-hover:gap-3 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#00213a] rounded"
                  >
                    Learn More
                    <ArrowRightIcon />
                  </a>
              ...
              {/* Arts & Technology */}
              <div className="group relative bg-white rounded-3xl overflow-hidden border-2 border-gray-200 hover:border-[#fdbb2e] transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-[#fdbb2e]/10 to-transparent rounded-bl-[120px] group-hover:from-[#fdbb2e]/20 transition-colors duration-300"></div>
                <div className="relative p-8 sm:p-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#fdbb2e] via-[#fdc951] to-[#fdd874] rounded-2xl flex items-center justify-center mb-6 shadow-lg text-gray-900 group-hover:scale-110 transition-transform duration-300">
                    <SparklesIcon />
                  </div>
                  ...
                  <a
                    href="#programs"
                    className="inline-flex items-center gap-2 text-[#fdbb2e] font-bold group-hover:gap-3 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#fdbb2e] rounded"
                  >
                    Explore Programs
                    <ArrowRightIcon />
                  </a>
        ...
        <section className="py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-black text-gray-900 mb-4">Community <span className="text-[#fdbb2e]">Partners</span></h2>
              <p className="text-lg text-gray-600">Collaborating for student success</p>
            </div>

            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { name: 'Harlem YMCA', url: '/harlem_ymca', color: 'from-[#00213a] to-[#003a5d]' },
                { name: 'Global Kids, Inc.', url: '/global_kids_inc', color: 'from-[#00213a] to-[#003a5d]' },
                { name: 'Cool Culture', url: '/cool_culture', color: 'from-[#fdbb2e] to-[#fdc951]' },
                { name: 'Union Settlement', url: '/union_settlement', color: 'from-[#fdbb2e] to-[#fdc951]' },
              ].map((partner, idx) => (
                <a
                  key={idx}
                  href={partner.url}
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div id="events">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <a href={schoolData.quickLinks.calendar} className="text-[#00213a] font-bold text-sm hover:underline">
                    View Calendar
                  </a>
                </div>
                <div className="bg-gradient-to-br from-[#00213a] to-[#003a5d] rounded-2xl p-8 text-white text-center">
                  <CalendarIcon />
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-white text-[#00213a] font-bold rounded-full hover:bg-gray-50 transition-colors duration-200"
                  >
                    <CalendarIcon />
                    Open Calendar
                  </a>
        ...
        <section id="visit" className="relative py-32 overflow-hidden">
          <div className="absolute inset-0 bg-[#00213a]"></div>
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="inline-flex items-center gap-2 bg-[#fdbb2e] px-4 py-2 rounded-full mb-6 text-gray-900 font-bold text-sm">
              <SparklesIcon />
              Join Our Community
            </div>
            <h2 className="text-5xl md:text-6xl font-black text-white mb-6 leading-tight">
              You Belong<br />
              at <span className="text-[#fdbb2e]">PS 96</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#contact"
                className="inline-flex items-center gap-2 px-10 py-5 text-lg font-black text-gray-900 bg-[#fdbb2e] hover:bg-[#fdc951] rounded-2xl shadow-2xl hover:shadow-[#fdbb2e]/50 transition-all duration-200"
              >
                Schedule a Visit
                <ArrowRightIcon />
              </a>
